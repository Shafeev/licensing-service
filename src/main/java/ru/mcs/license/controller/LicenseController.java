package ru.mcs.license.controller;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;
import ru.mcs.license.License;
import ru.mcs.license.service.LicenseService;
...
public class LicenseController {
    ...
    @PostMapping()
    public ResponseEntity<String> cretaeLicense(@PathVariable("organizationId") String organizationId, @RequestBody License request) {
